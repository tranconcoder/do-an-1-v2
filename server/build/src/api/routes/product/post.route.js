...
const productPostRoute = (0, express_1.Router)();
/* =================== Create product =================== */
productPostRoute.post('/create', (0, joiValidate_middleware_1.default)(index_joi_1.createProductSchema), (0, catchError_middleware_1.default)(product_controller_1.default.createProduct));
